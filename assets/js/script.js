 ...
 const tareas = [
    { id: 1, descripcion: "Pagar Pensión Dante", completado: false },
    { id: 2, descripcion: "Pagar pensión Anais", completado: false },
    { id: 3, descripcion: "Hacerme la vasectomia", completado: false },
  ];
      ...
      `
        <li class="tarea-item list-group-item d-flex justify-content-between align-items-center">
          <div class="row w-100">
            ...
            <div class="col-2 text-center">
              <button class="btn btn-warning btn-sm" onclick="deleteTask(${tarea.id})">Eliminar</button>
            </div>
          </div>
        </li>
      `
